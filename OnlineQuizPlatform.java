...
public class OnlineQuizPlatform {
    public static void main(String[] args) {
        ...
        questions.add(new Question("What is the capital of Madhya Pradesh?",
                List.of("Indore", "Ujjain", "Bhopal", "Jabalpur"), 2));
        questions.add(new Question("Who is the Prime Minister of India?",
                List.of("Narendra Modi", "Amit Shah", "Arvind Kejriwal", "Rahul Gandhi"), 0));
        // Add more questions
